...
public class App 
{
	...
	{		Connection conn =Connect.getConnection();
		...
		StructureCreation structureCreation=new StructureCreation();
		structureCreation.structure();
                try {
			conn.close();
	...
	private static void validateAssignmentCategory(Connection conn, Data a) throws SQLException {
	...
	static String addAssignmentCategory(Connection conn, String name, String subject, String assigncategory, String date, int marks) {
		...
		Data a = new Data(name, subject, assigncategory, date, marks);  
		try {
	...
	static String addStudentData(Connection conn, String n, String sub, String category, String date, int marks) {
		...
		try {
			Data a = new Data(n, sub, category, date, marks);
			validateAssignmentCategory(conn, a);
